...
class ProductReviewsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_review" do
    assert_difference('ProductReview.count') do
      post product_reviews_url, params: { product_review: { author: @product_review.author, comment: @product_review.comment, product_id: @product_review.product_id, rating: @product_review.rating } }
    end
  ...
  test "should update product_review" do
    patch product_review_url(@product_review), params: { product_review: { author: @product_review.author, comment: @product_review.comment, product_id: @product_review.product_id, rating: @product_review.rating } }
